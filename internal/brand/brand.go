...
// Palette hex values. AccentHex is the brand blue used for the logo, titles,
// selection and the "$" sigils in the Quick Start guide; DimHex is the muted
// grey used for subtitles, descriptions and the "# comment" hints; GreenHex
// marks a present API key and a successful save; ErrorHex marks validation
// failures and a missing key.
const (
	AccentHex = "#5A8DEE"
	DimHex    = "#8A8A8A"
	GreenHex  = "#98C379"
